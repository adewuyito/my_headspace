...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/journey_icon.svg
  SvgGenImage get journeyIcon =>
      const SvgGenImage('assets/icons/journey_icon.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/biometric_image.png
  AssetGenImage get biometricImage =>
      const AssetGenImage('assets/images/biometric_image.png');

  /// File path: assets/images/biometric_image_2.png
